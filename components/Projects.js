          ...
          <div className="slide-1 rounded-md p-7 mt-7 text-center bg-black shadow-lg  md:text-left">
            ...
            <div className="md:ml-6 text-center">
              ...
              <p className="text-gray-300">
                ...
                <p>
                  Built on NextJs and having various functionalities making your
                  problem solving journey much better.
                </p>
                <p>
          ...
          <div className="slide-2 rounded-md p-7 mt-7 text-center bg-black shadow-lg  md:text-left">
            ...
            <div className="md:ml-6 text-center">
              ...
              <div className="buttons flex my-2 justify-center gap-4">
                ...
                <div className="view_demo ">
                  <a
                    href="https://github.com/devendra0009/myDiary#readme"
                    target="_blank"
                  >
                    <button
                      type="button"
                ...
                <div className="view_code ">
                  <a
                    href="https://github.com/devendra0009/myDiary"
                    target="_blank"
                  >
                    <button
                      type="button"
          ...
          <div className="slide-3 rounded-md p-7 mt-7 text-center bg-black shadow-lg  md:text-left">
            ...
            <div className="md:ml-6 text-center">
              ...
              <p className="text-gray-300">
                ...
                <p>
                  This app uses ReactJs and its hooks to integrate our page with
                  a external newsApi to show real-time Data.
                </p>
                <p>
              ...
              <div className="buttons flex my-2 justify-center gap-4">
                ...
                <div className="view_demo ">
                  <a
                    href="https://github.com/devendra0009/KhabriBhai#readme"
                    target="_blank"
                  >
                    <button
                      type="button"
